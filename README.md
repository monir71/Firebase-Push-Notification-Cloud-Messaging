...
FirebaseMsgService.kt (My custom class extends FirebaseMessagingService)
...
Dont forget to add google-services.json file into your project

Google Firebase Console:
Cloud Messaging
TestMessage with Token (find it into LogCat after runing the project)
